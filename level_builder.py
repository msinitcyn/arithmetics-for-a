...
class LevelOne():
    ...
    def get_task_description(self):
        return "Уровень {}. Простое сложение.".format(self.level_number)

    def get_task(self):
        operand1 = randrange(5)
        operand2 = randrange(5)
        task_result = operand1 + operand2
        task_string = "{} + {} = ?".format(operand1, operand2)
...
class LevelTwo():
    ...
    def get_task_description(self):
        return "Уровень {}. Сложение.".format(self.level_number)
...
class LevelThree():
    ...
    def get_task_description(self):
        return "Уровень {}. Вычитание.".format(self.level_number)
...
class LevelFour():
    ...
    def get_task_description(self):
        return "Уровень {}. Простое двойное сложение.".format(self.level_number)
